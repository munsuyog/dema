  ...
  return (
    <section id='join-us-section'>
        ...
        <svg style={{
                ...
                <path fill="#0143BE" fillOpacity=".2" d="M-125 461 C137.395
                113.119 852.749 -373.915 1615 461H-125Z" style={{animation: "paths 20s infinite linear"}}>
                </path>
                <circle cx="50%" cy="115%" r="119.5" stroke="#0143BE" strokeOpacity="0.2" ></circle>
                <circle cx="50%" cy="115%" r="139.5" stroke="#0143BE" strokeOpacity="0.4"></circle>
