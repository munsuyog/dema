  ...
  return (
    <div className={`learn-other-faq ${isOpen ? 'active' : ''}`}>
        <div className='learn-other-faq-header' onClick={() => {setIsOpen(!isOpen)}}>
            ...
            <img src="/images/learn/learn-section/faq/subfaq-dropdown.svg" width={30} height={30} className={isOpen ? 'learn-other-subfaq-dropdown active' : 'learn-other-subfaq-dropdown'} alt='dropdown' />
        </div>
        ...
        <img src="/images/learn/learn-section/faq/leaf-arrow.svg" width={54} height={149} className={isOpen ? 'learn-other-subfaq-leaf-arrow active' : 'learn-other-subfaq-leaf-arrow'} alt='dropdown' />
    ...
    return (
        <div className={isOpen ? 'learn-other-subfaq active' : 'learn-other-subfaq'}>
            <div className='learn-other-subfaq-header' onClick={() => {setIsOpen(!isOpen)}}>
                <img src="/images/learn/learn-section/faq/subfaq-dropdown.svg" width={24} height={24} className={isOpen ? 'learn-other-subfaq-dropdown active' : 'learn-other-subfaq-dropdown'} alt='dropdown' />
