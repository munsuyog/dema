...
const CompareCardMobile = ({ company, receipts }) => {
  ...
  useEffect(() => {
    if (showOperations && inView) {
      receipts.MarketPlace.elements.forEach((receipt, index) => {
        const timer = setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        animate={{ opacity: isHeaderAnimating ? 0.5 : 1, fontSize: 12 }}
        exit={{ fontSize: 14 }}
...
export default CompareCardMobile;